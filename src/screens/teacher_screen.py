        ...
        if st.button(
            ...
            with st.spinner(
                ...
                for idx, image in enumerate(
                    ...
                    # ---------------------------------------------
                    # Store recognized enrolled students
                    # ---------------------------------------------
                ...
                # =================================================
                # STEP 4
                # NO ENROLLED STUDENT RECOGNIZED
                # =================================================
                ...
                for node in valid_enrolled_students:
                    ...
                    # ---------------------------------------------
                    # Get photo sources for this student
                    # ---------------------------------------------
